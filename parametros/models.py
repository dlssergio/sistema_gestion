# parametros/models.py (VERSIÓN FINAL, ROBUSTA Y CONSISTENTE)
...
def get_default_moneda_pk():
    moneda, _ = Moneda.objects.get_or_create(es_base=True, defaults={'nombre': 'Peso Argentino', 'simbolo': 'ARS', 'cotizacion': 1.00})
    return moneda.pk