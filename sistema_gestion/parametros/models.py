# parametros/models.py (VERSIÓN CON SISTEMA DE IMPUESTOS ROBUSTO)

from django.db import models
from django.contrib.auth.models import Permission, User
from django.utils import timezone  # Se añade para la vigencia


# --- MODELOS EXISTENTES (TipoComprobante, Contador, Moneda, etc. se mantienen igual) ---
...
class Moneda(models.Model):
    ...
    # Cambiamos el método __str__ para que devuelva "SÍMBOLO - Nombre"
...
# <<< INICIO: REFACTORIZACIÓN DEL SISTEMA DE IMPUESTOS >>>

# 1. Se elimina el modelo 'ReglaImpuesto'.

# 2. Se añaden los nuevos modelos para una arquitectura robusta.
class CategoriaImpositiva(models.Model):
    """Categorías de productos para impuestos. Ej: General (IVA 21%), Exento (0%)"""
    nombre = models.CharField(max_length=100, unique=True)
...
class Impuesto(models.Model):
    """
    Definición de un impuesto específico con su alícuota.
    Soporta vigencia temporal y aplicación condicional.
    """
...
# <<< FIN: REFACTORIZACIÓN DEL SISTEMA DE IMPUESTOS >>>
...
# <<< INICIO: NUEVO MODELO PARA GRUPOS >>>
