...
// COLUMNAS REF SIN PRECIO
const columns = ref([
  { title: 'Artículo', dataIndex: 'articulo', width: '60%' },
...
const onFinish = async () => {
  ...
  try {
    ...
    message.success('Remito de Venta guardado')
